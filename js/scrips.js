document.getElementById("btn-inisiar-sesión").addEventListener("click",iniciarSesion);
document.getElementById("btn-Registrarse").addEventListener("click",register);
window.addEventListener("resize", anchoPage);

//Declarando de variable
var contenedor_login_registre=document.querySelector(".contenedor--login-register");
