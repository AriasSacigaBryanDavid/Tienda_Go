            ...
            <div class="modal-body card-header-a text-white">
                <form method="post" id="frmProveedor">
                    <div class="form-group d-flex justify-content-between">
                        <h4 class="modal-title text-white" id="title">Nuevo Proveedor</h4>
                    ...
                    <button class="btn btn-b text-white" type="button" onclick="registrarPro(event);" id="btnAccion">Registrar</button>
